    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="POST" action="/admin/account/password">
                ...
                <button type="submit" class="btn btn-coral"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" viewBox="0 0 24 24" class="account-icon"><path d="M18 8h-1V6A5 5 0 0 0 7 6v2H6a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V10a2 2 0 0 0-2-2zm-6 9a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm3.1-9H8.9V6a3.1 3.1 0 0 1 6.2 0v2z"/></svg>Update Password</button>
            </form>
        </div>
    </div>
</div>
...
<div class="card">
    ...
    <div class="card-body">
        <table class="account-details-table">
            <tr><td class="account-label">Role</td><td><span class="badge account-role-badge">Administrator</span></td></tr>
            <tr><td class="account-label">Status</td><td><span class="badge badge-approved">Active</span></td></tr>
            <tr><td class="account-label">Member Since</td><td class="account-date">{{ auth()->user()->created_at->format('F d, Y') }}</td></tr>
        </table>
    </div>
</div>

<div class="account-page account-danger-section">
