...
<style>
    ...
    input[type="email"] { width: 100%; padding: 0.7rem 1rem; border: 1.5px solid #ddd6c8; border-radius: 8px; font-size: 0.95rem; background: var(--bone); color: var(--charcoal); transition: border-color 0.2s; outline: none; }
